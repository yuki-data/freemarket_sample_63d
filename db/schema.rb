...
ActiveRecord::Schema.define(version: 2019_12_03_074252) do
  ...
  add_foreign_key "bought_products", "users", column: "buyer_id"
  ...
  add_foreign_key "sold_products", "users", column: "buyer_id"
end
