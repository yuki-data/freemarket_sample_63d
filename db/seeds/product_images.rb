...
product.product_images.create!(
  [
    { image: "products_temporary/food_curryrice_white.png" },
    { image: "products_temporary/food_gyouza_enban.png" },
    { image: "products_temporary/food_nasu_nibitashi.png" },
    { image: "products_temporary/food_nasu_yakinasu.png" },
    { image: "products_temporary/food_sauce_katsudon_fukui.png" }
  ]
)
